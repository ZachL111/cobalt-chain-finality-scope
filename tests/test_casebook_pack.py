"""Regression checks for the cobalt-chain-finality-scope casebook."""
...
from casebook.harness import assert_expected, cobalt_chain_finality_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_chain_finality_scope_summary(), assert_expected())
